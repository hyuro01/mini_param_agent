...
from mini_param_agent.tools import BashTool, ReadTool, WriteTool
...
async def demo_direct_note_usage():
    ...
    try:
        ...
        result = await record_tool.execute(
            content="Project name: mini_param_agent, Tech: Python 3.12 + async",
...
"""
        ...
        - I'm building an AI agent for ML experiments called "mini_param_agent"
