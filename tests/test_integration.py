    ...
    with tempfile.TemporaryDirectory() as workspace_dir:
        ...
        try:
            ...
            mcp_tools = await load_mcp_tools_async(
                config_path="mini_param_agent/config/mcp.json"
            )
            if mcp_tools:
        ...
        task = """
        Create a Python file named hello.py in the workspace that prints "Hello, mini_param_agent!".
