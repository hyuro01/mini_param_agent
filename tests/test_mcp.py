...
from mini_param_agent.tools.mcp_loader import (
    MCPServerConnection,
    MCPTimeoutConfig,
...
def mcp_config():
    ...
    mcp_config_path = Path("mini_param_agent/config/mcp.json")
...
async def test_mcp_tools_loading():
    ...
    try:
        # Load MCP tools
        tools = await load_mcp_tools_async("mini_param_agent/config/mcp.json")
